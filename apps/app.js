			...
			await fetch('./main.json')
				...
				.then((data) => {
					...
					gotdata.forEach((district) => {
						...
						fetch(
							`http://api.openweathermap.org/data/2.5/air_pollution?lat=${district.position.lat}&lon=${district.position.long}&appid=${openweathermapkey}`
						)
							.then((data) => data.json())
							.then((res) => {
								...
								fetch(
									`http://api.openweathermap.org/data/2.5/weather?lat=${district.position.lat}&lon=${district.position.long}&appid=${openweathermapkey}`
								)
									.then((data) => data.json())
									.then((res) => {
										const { name } = res;
                                                ...
                                                <div class='innercontent'>
                                                    ...
                                                    <p>
                                                        <details>
                                                            ...
                                                            <p>&CircleDot; Latitude : <span id='lat'> ${district.position.lat}</span></p>
                                                            <p>&CircleDot; Longitude : <span id='lat'> ${district.position.long}</span></p>
                                                            <p>&CircleDot; Area : <span id='lat'> ${district.position.area} km<sup>2</sup></span></p>
                                                        </details>
                                                        <div class='aqidetail'>
